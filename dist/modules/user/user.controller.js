...
router.patch("/:userId/block", (0, authentication_middleware_1.authorization)([model_1.RoleEnum.admin]), (0, validation_middleware_1.validation)(validators.blockUser), user_service_1.default.blockUser);
